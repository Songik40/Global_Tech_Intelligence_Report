...
AI 경쟁은 GPU 구매를 넘어 **HBM, advanced packaging, networking, custom silicon, public/sovereign compute, integrated AI servers, data center, power**를 포함하는 인프라 체인 경쟁으로 확장되고 있다.
...
HBM capacity, packaging yield, interconnect, custom-XPU integration, integrated-server delivery, power, cooling, construction lead time, access allocation.

## Watch

- Dell AI-server backlog의 실제 매출 전환과 마진
- NVLink Fusion 기반 custom XPU의 실제 양산·고객 채택
- LUMI-AI 설치와 실제 사용자 compute allocation
